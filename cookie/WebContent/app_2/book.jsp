...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <style>
        ...
        table { width: 300px; min-height: 25px; line-height: 35px; text-align: center; border-collapse: collapse; padding:2px;}   
...
<table class="table" align="center">
  	<caption><h2>书的信息</h2></caption>
	<td>
		<h3>Book: <%= request.getParameter("book") %></h3>
	
	<a class="a" href="books.jsp"><h2>返回</h2></a>
